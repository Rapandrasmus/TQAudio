...
class TQAudio : public Object
{
	...
	public:
		...
		Ref<TQAudioSourceDecodedMemory> register_sound_from_decoded_memory(String m_name_hint, PackedByteArray m_data, uint32_t sample_rate, uint32_t channels, int format);
